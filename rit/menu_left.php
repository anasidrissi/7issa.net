...
echo "</span>";
echo '<div class="t"><span class="titre_menu_left"><img id="menu_img" src="../img/menu_img/rit.png" /><a title="Repair-Informatique-Technologie" href="#">RIT :</a></div><span onClick="fademenu(\'ccc\',\'arrow2\')" id="arrow2">&#9662;</span></span>';
echo "<span id='ccc'>";
foreach($matieres as $element){
	$matiers_key=array_search($element,$matieres);
	if(preg_match('#^rit#', $matiers_key)){
