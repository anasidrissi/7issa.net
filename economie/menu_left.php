...
<?php
echo '<div class="t"><span class="titre_menu_left"><img id="menu_img" src="../img/menu_img/eco.png" /><a href="../economie">Economie :</a></div><span onClick="fademenu(\'ddd\',\'arrow\')" id="arrow">&#9662;</span></span>';      //pour la ligne suivant cett solution est temporaire n'est pas finale
echo "<span id='ddd'>";
...
echo "</span>";
echo '<div class="t"><span class="titre_menu_left"><img id="menu_img" src="../img/menu_img/rit.png" /><a title="Repair-Informatique-Technologie" href="../rit">RIT :</a></div><span onClick="fademenu(\'ccc\',\'arrow2\')" id="arrow2">&#9662;</span></span>';
echo "<span id='ccc'>";
foreach($matieres as $element){
	$matiers_key=array_search($element,$matieres);
	if(preg_match('#^rit#', $matiers_key)){
...
<div class="t"><span class="titre_menu_left"><img id="menu_img" src="../img/menu_img/plan_comptable.png" /><a href="../plan_comptable.php">Plan comptable</a></span></div>
