...
<ul class="menu_header">
    ...
    <li><a href="../about">Apropos du 7issa.com</a></li>
    <li title="comment j'utulise 7issa.com"><a href="../use">Guide d’utilisation</a></li>
    <li title="partage vos cours avec 7issa.com"><a href="../help-us">Partagez des cours avec nous</a></li>
    <li title="contacter le webmaster du 7issa.com pour des information ou autre chose"><a href="../contacte">Contactez le webmaster du 7issa.com</a></li>
    <li title="declarer des fautes sur des cours et ameliorer votre navigation dans 7issa.com"><a href="../declarer">Declarer des fautes dans un cour ou un document</a></li>
</ul>
</div>
</div>
</body>